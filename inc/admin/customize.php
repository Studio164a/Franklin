...
.campaign-button, .active-campaign, .sticky { background-color: <?php echo $accent ?>; color: <?php echo $accent_text ?>; }
a:hover { color: <?php echo $accent_hover ?>;}
.sticky .post-title { border-color: <?php echo $accent_hover ?>; }
