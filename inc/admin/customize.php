...
/* Button text colour */
input[type=submit], input[type=reset], button, .button, .active-campaign .campaign-button, #site-navigation .menu-button, .button.button-alt:hover, .account-links .button.button-alt:hover::before, .sticky.block, .sticky.block a, .campaign-support .button:hover { color: <?php echo $button_text ?>; }
